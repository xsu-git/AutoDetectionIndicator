...
import os
from process.model_train import MachineLearnTrain,ProfessionalBacktester
...
if __name__ == '__main__':
    ...
    features_df = FeatureExtractorLoader(df_tech,peak_tech).extract_all_features(exclude=["PeakStructureFeature"]) #未来函数
    ...
    ProfessionalBacktester().backtest(signals_df,df_tech)
